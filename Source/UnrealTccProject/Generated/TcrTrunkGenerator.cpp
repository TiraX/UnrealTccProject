...
FTccNodePtr UTcrTrunkGenerator::CreateNode() 
{
	TSharedPtr<FTcrTrunkGenerator> Node = MakeShared<FTcrTrunkGenerator>();
	SyncParams(Node);
	return Node;
}
void UTcrTrunkGenerator::SyncParams(FTccNodePtr InNode) 
{
	TSharedPtr<FTcrTrunkGenerator> Node = StaticCastSharedPtr<FTcrTrunkGenerator>(InNode);
 ...
 FTcrTrunkGenerator::FTcrTrunkGenerator() 
{
	InitInputsCount(0);
...
void FTcrTrunkGenerator::Cook() 
{
	...
	SetGeoResult(UTcrTrunkGenerator::output0, enable_bend->GetGeoResult(0));
}
