...
#include "TccRamp.h"
#include "TcrFernSubbranches01.generated.h"

UCLASS()
class UNREALTCCPROJECT_API UTcrFernSubbranches01 : public UTccRecipeGeoDefine
{
	GENERATED_BODY()
public:
	enum EOutputs
...
class FTccMerge;
class UNREALTCCPROJECT_API FTcrFernSubbranches01 : public FTccNode
{
public:
	FTcrFernSubbranches01() ;
	virtual ~FTcrFernSubbranches01() ;
