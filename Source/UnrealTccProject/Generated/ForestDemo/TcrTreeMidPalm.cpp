...
void FTcrTreeMidPalm::Cook() 
{
	...
	}
	{
		...
		subbranch_scatter->PitchRamp = ETccRampInterp::Linear;
		subbranch_scatter->PitchRamp.ResizeRampPoints(2);
		subbranch_scatter->PitchRamp.AddRampPoint(0.0000f, 0.0000f);
		subbranch_scatter->PitchRamp.AddRampPoint(1.0000f, 1.0000f);
		subbranch_scatter->ScaleRamp = ETccRampInterp::Linear;
		subbranch_scatter->ScaleRamp.ResizeRampPoints(3);
		subbranch_scatter->ScaleRamp.AddRampPoint(0.0000f, 0.6667f);
		subbranch_scatter->ScaleRamp.AddRampPoint(0.4416f, 1.0000f);
		subbranch_scatter->ScaleRamp.AddRampPoint(1.0000f, 0.7000f);
	...
	}
	{
		...
		fruit_scatter->PitchRamp = ETccRampInterp::Linear;
		fruit_scatter->PitchRamp.ResizeRampPoints(2);
		fruit_scatter->PitchRamp.AddRampPoint(0.0000f, 0.0000f);
		fruit_scatter->PitchRamp.AddRampPoint(1.0000f, 1.0000f);
		fruit_scatter->ScaleRamp = ETccRampInterp::Linear;
		fruit_scatter->ScaleRamp.ResizeRampPoints(10);
		fruit_scatter->ScaleRamp.AddRampPoint(0.0000f, 1.0000f);
		fruit_scatter->ScaleRamp.AddRampPoint(0.0998f, 0.7333f);
		fruit_scatter->ScaleRamp.AddRampPoint(0.1817f, 1.0000f);
		fruit_scatter->ScaleRamp.AddRampPoint(0.2782f, 0.8000f);
		fruit_scatter->ScaleRamp.AddRampPoint(0.3895f, 1.0000f);
		fruit_scatter->ScaleRamp.AddRampPoint(0.4664f, 0.7333f);
		fruit_scatter->ScaleRamp.AddRampPoint(0.6318f, 1.0000f);
		fruit_scatter->ScaleRamp.AddRampPoint(0.7316f, 0.8000f);
		fruit_scatter->ScaleRamp.AddRampPoint(0.8592f, 1.0000f);
		fruit_scatter->ScaleRamp.AddRampPoint(1.0000f, 1.0000f);
