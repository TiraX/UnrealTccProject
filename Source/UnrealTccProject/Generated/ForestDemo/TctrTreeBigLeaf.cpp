...
#include "HScript.h"
 ...
 UTctrTreeBigLeaf::UTctrTreeBigLeaf() 
{
...
void UTctrTreeBigLeaf::UpdateParameters() 
{
	{
		// Node: normal
	...
	}
	{
		...
		_albedo->Color = FVector4f(0.000000f, 1.000000f, 0.000000f, 1.000000f);
		_albedo->UpdateHelperNodeParameters();
	}
}
void UTctrTreeBigLeaf::FillComputeGraph(UTccComputeGraph* InComputeGraph,int32 InOutputIndex,TObjectPtr<UTexture2D> OutTexture) 
{
	{
		// Node: normal
