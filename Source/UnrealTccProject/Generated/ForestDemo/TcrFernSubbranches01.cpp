...
#include "HScript.h"
 ...
 UTcrFernSubbranches01::UTcrFernSubbranches01() 
{
...
FTccNodePtr UTcrFernSubbranches01::CreateNode() 
{
	TSharedPtr<FTcrFernSubbranches01> Node = MakeShared<FTcrFernSubbranches01>();
	SyncParams(Node);
	return Node;
}
void UTcrFernSubbranches01::SyncParams(FTccNodePtr InNode) 
{
	TSharedPtr<FTcrFernSubbranches01> Node = StaticCastSharedPtr<FTcrFernSubbranches01>(InNode);
 ...
 FTcrFernSubbranches01::FTcrFernSubbranches01() 
{
	InitInputsCount(2);
...
void FTcrFernSubbranches01::Cook() 
{
	{
		// Node: trunk_dummy
	...
	}
	{
		...
		fern_leaf_scatter->SetInput(1, GetInput(1));
		...
		fern_leaf_scatter->AgeDisRamp.AddRampPoint(1.0000f, 0.4333f);
		...
		fern_leaf_scatter->AgeDisShowAdv = 1;
		fern_leaf_scatter->AgeDisAdv = 1;
		fern_leaf_scatter->Mirror = int32(Mirror);
		fern_leaf_scatter->DropR = float(DropR);
		fern_leaf_scatter->UseInstanceId = UTcrTreeLeafScatter::Ordered;
	...
	SetGeoResult(UTcrFernSubbranches01::output0, pack_subbranch->GetGeoResult(0));
}
