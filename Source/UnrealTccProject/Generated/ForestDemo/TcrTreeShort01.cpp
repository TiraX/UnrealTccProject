...
{
	{
		...
		tcr_tree_trunk_growth1->VOffset = -0.332000f;
	...
	}
	{
		...
		branch1->Shape.ResizeRampPoints(6);
		...
		branch1->ScaleRamp.AddRampPoint(0.0033f, 0.7333f);
	...
	}
	{
		...
		branch2->Shape.ResizeRampPoints(6);
	...
	}
	{
		...
		branch3->Shape.ResizeRampPoints(6);
