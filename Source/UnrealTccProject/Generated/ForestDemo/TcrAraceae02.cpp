...
#include "HScript.h"
 ...
 UTcrAraceae02::UTcrAraceae02() 
{
}
FTccNodePtr UTcrAraceae02::CreateNode() 
{
	TSharedPtr<FTcrAraceae02> Node = MakeShared<FTcrAraceae02>();
	SyncParams(Node);
	return Node;
}
void UTcrAraceae02::SyncParams(FTccNodePtr InNode) 
{
	TSharedPtr<FTcrAraceae02> Node = StaticCastSharedPtr<FTcrAraceae02>(InNode);
	Node->Gseed = Gseed;
}

 FTcrAraceae02::FTcrAraceae02() 
{
	InitInputsCount(0);
...
{
	{
		...
		trunk->TreeAge = 1.420000f;
		trunk->MaxAge = 0.450000f;
	...
	}
	{
		...
		branch->Gseed = 47;
		branch->StartPercent = 0.116000f;
		branch->AgeDis = 0.100000f;
		branch->MaxAge = 0.920000f;
		branch->MaxAgeShowAdv = 1;
		branch->MaxAgeAdv = 1;
		branch->AroundRange = FVector2f(-80.000000f, 80.000000f);
		branch->Yaw = 62.000000f;
		branch->Pitch0 = 18.500000f;
		branch->Pitch1 = 43.500000f;
	...
	}
	{
		...
		leaf1->ShapeLeft.ResizeRampPoints(5);
		leaf1->ShapeLeft.AddRampPoint(0.0000f, 0.3000f);
		leaf1->ShapeLeft.AddRampPoint(0.0701f, 1.0000f);
		leaf1->ShapeLeft.AddRampPoint(0.7025f, 1.0000f);
		leaf1->ShapeLeft.AddRampPoint(0.8573f, 0.8667f);
		...
		leaf1->ShapeRight.AddRampPoint(0.7037f, 0.8000f);
		...
		leaf1->ULen = 0.700000f;
		leaf1->VLen = 0.500000f;
		leaf1->VSegs = 12;
		leaf1->Stem = 0.041000f;
		leaf1->UBend = 57.599998f;
		leaf1->UBendOffset = 0.471000f;
		leaf1->VBend = 18.600000f;
		leaf1->YawBeginLeft = 43.500000f;
		leaf1->YawBeginRight = 26.000000f;
		leaf1->Amp = 0.276000f;
		leaf1->Freq = 1.114000f;
		leaf1->Cook();
	}
	{
		// Node: mi_leaf1
	...
	}
	{
		...
		leaf2->ShapeLeft.ResizeRampPoints(5);
		leaf2->ShapeLeft.AddRampPoint(0.0000f, 0.3000f);
		leaf2->ShapeLeft.AddRampPoint(0.0810f, 0.6667f);
		leaf2->ShapeLeft.AddRampPoint(0.5550f, 0.7333f);
		leaf2->ShapeLeft.AddRampPoint(0.8803f, 0.7000f);
		...
		leaf2->ULen = 1.169000f;
		leaf2->VLen = 0.564000f;
		leaf2->VSegs = 12;
		leaf2->Stem = 0.041000f;
		leaf2->UBend = 22.600000f;
		leaf2->UBendOffset = 0.471000f;
		leaf2->VBend = 18.600000f;
		leaf2->YawBeginLeft = 43.500000f;
		leaf2->YawBeginRight = 26.000000f;
		leaf2->Amp = 0.276000f;
	...
	}
	{
		...
		tcr_tree_leaf_scatter1->PitchAlongTrunk.AddRampPoint(1.0000f, 0.3667f);
		...
		tcr_tree_leaf_scatter1->ScaleAlongTrunk.ResizeRampPoints(8);
		tcr_tree_leaf_scatter1->ScaleAlongTrunk.AddRampPoint(0.0000f, 1.0000f);
		tcr_tree_leaf_scatter1->ScaleAlongTrunk.AddRampPoint(0.0443f, 0.8667f);
		tcr_tree_leaf_scatter1->ScaleAlongTrunk.AddRampPoint(0.0959f, 1.0000f);
		tcr_tree_leaf_scatter1->ScaleAlongTrunk.AddRampPoint(0.2017f, 0.7333f);
		tcr_tree_leaf_scatter1->ScaleAlongTrunk.AddRampPoint(0.3333f, 1.0000f);
		tcr_tree_leaf_scatter1->ScaleAlongTrunk.AddRampPoint(0.6089f, 0.7000f);
		tcr_tree_leaf_scatter1->ScaleAlongTrunk.AddRampPoint(0.8044f, 1.0000f);
		...
		tcr_tree_leaf_scatter1->YawOffsetR = 8.700000f;
		tcr_tree_leaf_scatter1->PitchRange = FVector2f(-18.799999f, 15.000000f);
		tcr_tree_leaf_scatter1->PitchShowAdv = 1;
		tcr_tree_leaf_scatter1->PitchAdv = 1;
		tcr_tree_leaf_scatter1->Scale = 0.220000f;
	...
	SetGeoResult(UTcrAraceae02::output0, tcc_merge3->GetGeoResult(0));
}
