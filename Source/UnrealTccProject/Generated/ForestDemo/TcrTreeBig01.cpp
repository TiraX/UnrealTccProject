...
#include "HScript.h"
 ...
 UTcrTreeBig01::UTcrTreeBig01() 
{
}
FTccNodePtr UTcrTreeBig01::CreateNode() 
{
	TSharedPtr<FTcrTreeBig01> Node = MakeShared<FTcrTreeBig01>();
	SyncParams(Node);
	return Node;
}
void UTcrTreeBig01::SyncParams(FTccNodePtr InNode) 
{
	TSharedPtr<FTcrTreeBig01> Node = StaticCastSharedPtr<FTcrTreeBig01>(InNode);
	Node->Gseed = Gseed;
}

 FTcrTreeBig01::FTcrTreeBig01() 
{
	InitInputsCount(0);
