 ...
 FTcrBigtree01::FTcrBigtree01() 
{
	...
	tcc_unpack2 = new FTccUnpack();
	tcc_unpack2->InitMultiRefs(false); // RefCount = 1
	tcc_unpack3 = new FTccUnpack();
	tcc_unpack3->InitMultiRefs(false); // RefCount = 1
...
void FTcrBigtree01::Cook() 
{
	...
	{
		tcc_unpack2->SetInput(0, tcr_leaf_generator_with_variations2);
		tcc_unpack2->Cook();
	}
	{
		tcc_unpack3->SetInput(0, tcc_unpack2);
		tcc_unpack3->Cook();
	}
	{
		merge_trunk_and_leaf->SetInput(0, tcr_tree_skin1);
		merge_trunk_and_leaf->SetInput(1, tcc_unpack3);
